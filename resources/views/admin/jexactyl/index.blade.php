        ...
        <div class="col-xs-12">
            ...
            ">
                ...
                <div class="box-body">
                    ...
                    @else
                    Jexactyl não está atualizado. <code>{{ config('app.version') }} (current) -> <a href="https://github.com/ashu11-a/jexactyl_pt-br/releases/v{{ $version->getPanel() }}" target="_blank">{{ $version->getPanel() }}</a> (latest)</code>
                    @endif
                </div>
            </div>
        </div>
