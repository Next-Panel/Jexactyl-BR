            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Recursos do Usuário</h3>
                    </div>
                    <form action="{{ route('admin.users.resources', $user->id) }}" method="POST">
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-3">
                                    <label for="store_balance" class="control-label">Total da Carteira</label>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="store_cpu" class="control-label">Total de CPU disponível</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="store_memory" class="control-label">Total de Memoria disponível</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="store_disk" class="control-label">Total de Disco disponível</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="store_slots" class="control-label">Total de Slots disponível</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="store_ports" class="control-label">Total de Portas disponível</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="store_backups" class="control-label">Total de Backups disponível</label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="store_databases" class="control-label">Total de Databases disponível</label>
                                    <div class="input-group">
                        ...
                        <div class="box-footer">
                            {!! csrf_field() !!}
                            <button type="submit" name="_method" value="PATCH" class="btn btn-sm btn-primary pull-right">Salvar Mudanças</button>
                        </div>
                    </form>
                </div>
            </div>
