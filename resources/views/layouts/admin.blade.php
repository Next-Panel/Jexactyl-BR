                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="{{ ! starts_with(Route::currentRouteName(), 'admin.index') ?: 'desactive' }}">
                                <a href="{{ route('index') }}">
                                    ...
                                    <span style="margin-left: 4px; font-size: 18px;">Voltar ao Painel</span>
                                </a>
                            </li>
                        <!-- Novo codigo-->
